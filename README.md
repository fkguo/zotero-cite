...
由于本人不经常使用`latex`以及`markdown`，只在写论文的时候才会用，如果您喜欢使用该插件，但对其中的一些细节有额外的需求，您可以写issue，另外对于本身有一些编程能力的用户，非常欢迎提交自己的代码（可能需要您自己测试一下，因为我实在有点懒惰）。如果您需要得到即使的反馈，请给我写邮件：[1281961491@qq.com](mailto:1281961491@qq.com)。
